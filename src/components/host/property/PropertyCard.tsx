...
export function PropertyCard({ listing, onContinue, onDeleted }: PropertyCardProps) {
  ...
  const handleDeleteError = (error: unknown) => {
    try {
      ...
      const message = anyErr?.response?.data?.message || anyErr?.message || "Failed to delete draft";
      toast.error(message);
    } catch {
              ...
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      This action cannot be undone. This will permanently delete this draft listing and remove its data from our servers.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
